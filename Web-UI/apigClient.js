...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            accessKey: 'AKIAUO46OQIS6DNBZZEU',
            secretKey: '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',
            sessionToken: '',
            region: 'us-east-1',
            apiKey: 'gkFIyyaHij4hvhuv8SPgC33DKwJwYQm49IwB6cs5',
    ...
    var invokeUrl = 'https://8mx7shqi3d.execute-api.us-east-1.amazonaws.com/dev';
